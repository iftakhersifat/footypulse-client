                ...
                <div className="flex items-center gap-5 relative">
                    ...
                    <div className="relative">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            ...
                            <span className="text-[9px] font-black text-zinc-500 uppercase tracking-[0.4em]">Elite Coaches</span>
                        </div>
                    </div>
                </div>
                ...
                <Link to="/managers">
                    <motion.div
                        ...
                        >
                            ...
                            <span className="relative z-10 group-hover:text-black transition-colors duration-300">All Managers</span>
