    ...
    <div className="flex items-center gap-5 relative">
        ...
        <div className="relative">
            ...
            <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-[9px] font-black text-zinc-500 uppercase tracking-[0.4em]">Elite Database</span>
            </div>
        </div>
    </div>
    ...
    <Link to="/players">
        <motion.div
            ...
            >
                ...
                <span className="relative z-10 group-hover:text-black transition-colors duration-300">All Players</span>
